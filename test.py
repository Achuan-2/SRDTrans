...
from movie_io import resolve_input_path, list_movie_files, movie_output_path, write_movie
...
parser.add_argument('--output_path', type=str, default=None, help="Output directory; omitted or empty means beside each input file")
        ...
        if '.pth' in aaa:
            ...
            for N in range(len(img_list)):
                ...
                with torch.no_grad():
                    ...
                    write_movie(result_name, output_img)
                    save_yaml_test(opt, os.path.splitext(result_name)[0] + '.yaml')
